...
Finally, given the reliance of neuroscience field on electrophysiological recordings, it is important to ascertain the compatibility of the presented system with such techniques. Previous reports of induced artefacts stemming from stepper-motor operation near these systems. As a result, we performed acute electrophysiological recordings from a mouse's brain (\ref{s:methods}) while simultaneously operating the syringe pump \ref{fig:Ephys}. 
