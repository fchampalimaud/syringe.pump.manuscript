...
To characterize the system, we chose two glass syringes models with total volumes compatible with those routinely used for animal experiments (5 and 10 $mL$, 1000 Series Syringes, Hamilton), leading to a single-full-step theoretical resolution of 0.33 and 0.66 $\mu L / step$.
